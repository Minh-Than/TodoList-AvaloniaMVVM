...
namespace TodoList_AvaloniaMVVM.Services;

public static class ToDoListFileService
{
    // This is a hard coded path to the file. It may not be available on every platform.
    // In your real world App you may want to make this configurable
